          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h3 className="font-bold text-lg leading-tight text-white" style={{ color: '#ffffff' }}>Church AI</h3>
              ...
              <div className="text-xs text-[#e9d5ff] font-medium leading-normal" style={{ color: '#e9d5ff' }}>
                Central Permission-Aware Conversational Assistant
              </div>
            </div>
          </div>
              ...
              >
                ...
                >
                  <div className="flex items-center space-x-2 mb-1 opacity-75 text-[11px]">
                    {msg.sender === 'assistant' ? (
                      <>
                        ...
                        <span className="font-semibold text-purple-300" style={{ color: '#d8b4fe' }}>Church AI</span>
                      </>
                    ) : (
                  ...
                  {msg.requiresConfirmation && msg.proposedActionPayload && (
                    <div className="mt-3 p-3 bg-purple-950/50 border border-purple-800/60 rounded-xl space-y-2 text-xs">
                      <div className="font-bold text-purple-200 flex items-center space-x-1">
                        <AlertCircle className="w-4 h-4 text-purple-400" />
                        <span>Proposed Action Details:</span>
                      </div>
                      <div className="bg-slate-900/90 p-2.5 rounded-lg border border-purple-900/60 text-slate-200">
                      ...
                      <div className="flex items-center space-x-2 pt-1">
                        <button
                          ...
                          className="flex items-center space-x-1 px-3 py-1.5 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-500 transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center space-x-1 px-3 py-1.5 bg-slate-800 text-slate-300 rounded-lg font-medium hover:bg-slate-700 transition-colors border border-slate-700"
                        >
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-slate-900 border border-slate-800 rounded-2xl rounded-bl-xs p-4 shadow-xs flex items-center space-x-3 text-slate-200">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-200" style={{ color: '#e2e8f0' }}>Consulting Church AI Services...</p>
                    <p className="text-[10px] text-slate-400" style={{ color: '#94a3b8' }}>Verifying role permissions & synthesizing response</p>
                  </div>
                </div>
              </div>
            )}
