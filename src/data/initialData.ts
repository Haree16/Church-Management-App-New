...
export const INITIAL_CHURCH_SETTINGS: Record<string, CompleteChurchSettings> = {
  'church-1': {
    ...
    memberSettings: {
      memberTypes: [
        { type: 'Pastor', displayName: 'Senior Pastor', description: 'Ordained pastoral clergy', isEnabled: true, colorBadge: 'bg-amber-950/80 text-amber-300 border-amber-800' },
        { type: 'Assistant Pastor', displayName: 'Associate / Assistant Pastor', description: 'Assisting pastoral team', isEnabled: true, colorBadge: 'bg-blue-950/80 text-blue-300 border-blue-800' },
        { type: 'Leader', displayName: 'Ministry Leader / Elder', description: 'Department and team coordinators', isEnabled: true, colorBadge: 'bg-purple-950/80 text-purple-300 border-purple-800' },
        { type: 'Clergy/Staff', displayName: 'Church Office & Staff', description: 'Administrative staff and officers', isEnabled: true, colorBadge: 'bg-emerald-950/80 text-emerald-300 border-emerald-800' },
        { type: 'Member', displayName: 'Committed Member', description: 'Baptized, registered church family', isEnabled: true, colorBadge: 'bg-slate-800 text-slate-200 border-slate-700' },
        { type: 'Regular Attender', displayName: 'Regular Attender', description: 'Regular attendee exploring membership', isEnabled: true, colorBadge: 'bg-teal-950/80 text-teal-300 border-teal-800' },
        { type: 'Visitor', displayName: 'First-Time / Guest Visitor', description: 'New guest visiting services', isEnabled: true, colorBadge: 'bg-rose-950/80 text-rose-300 border-rose-800' },
        { type: 'Youth', displayName: 'Youth & Young Adult', description: 'Teen and university student members', isEnabled: true, colorBadge: 'bg-sky-950/80 text-sky-300 border-sky-800' },
      ],
